...
//  return EEPROMClass::readAll (address, value);
  EEPROMClass::readBytes(address, &value, sizeof(uint8_t));
  return value;
}
...
int8_t EEPROMClass::readChar (int address)
{
  int8_t value = 0;
//  return EEPROMClass::readAll (address, value);
  EEPROMClass::readBytes(address, &value, sizeof(int8_t));
  return value;
}
...
int16_t EEPROMClass::readShort (int address)
{
  int16_t value = 0;
//  return EEPROMClass::readAll (address, value);
  EEPROMClass::readBytes(address, &value, sizeof(int16_t));
  return value;
}
...
uint16_t EEPROMClass::readUShort (int address)
{
  uint16_t value = 0;
//  return EEPROMClass::readAll (address, value);
  EEPROMClass::readBytes(address, &value, sizeof(uint16_t));
  return value;
}
...
int32_t EEPROMClass::readInt (int address)
{
  int32_t value = 0;
//  return EEPROMClass::readAll (address, value);
  EEPROMClass::readBytes(address, &value, sizeof(int32_t));
  return value;
}
...
uint32_t EEPROMClass::readUInt (int address)
{
  uint32_t value = 0;
//  return EEPROMClass::readAll (address, value);
  EEPROMClass::readBytes(address, &value, sizeof(uint32_t));
  return value;
}
...
int64_t EEPROMClass::readLong64 (int address)
{
  int64_t value = 0;
//  return EEPROMClass::readAll (address, value);
  EEPROMClass::readBytes(address, &value, sizeof(int64_t));
  return value;
}
...
uint64_t EEPROMClass::readULong64 (int address)
{
  uint64_t value = 0;
//  return EEPROMClass::readAll (address, value);
  EEPROMClass::readBytes(address, &value, sizeof(uint64_t));
  return value;
}
...
float_t EEPROMClass::readFloat (int address)
{
  float_t value = 0;
//  return EEPROMClass::readAll (address, value);
  EEPROMClass::readBytes(address, &value, sizeof(float_t));
  return value;
}
...
double_t EEPROMClass::readDouble (int address)
{
  double_t value = 0;
//  return EEPROMClass::readAll (address, value);
  EEPROMClass::readBytes(address, &value, sizeof(double_t));
  return value;
}
...
//  return EEPROMClass::writeAll (address, value);
  return EEPROMClass::writeBytes(address, &value, sizeof(uint8_t));
}

size_t EEPROMClass::writeChar (int address, int8_t value)
{
//  return EEPROMClass::writeAll (address, value);
  return EEPROMClass::writeBytes(address, &value, sizeof(int8_t));
}
...
{
//  return EEPROMClass::writeAll (address, value);
  return EEPROMClass::writeBytes(address, &value, sizeof(int16_t));
}

size_t EEPROMClass::writeUShort (int address, uint16_t value)
{
//  return EEPROMClass::writeAll (address, value);
  return EEPROMClass::writeBytes(address, &value, sizeof(uint16_t));
}

size_t EEPROMClass::writeInt (int address, int32_t value)
{
//  return EEPROMClass::writeAll (address, value);
  return EEPROMClass::writeBytes(address, &value, sizeof(int32_t));
}

size_t EEPROMClass::writeUInt (int address, uint32_t value)
{
//  return EEPROMClass::writeAll (address, value);
  return EEPROMClass::writeBytes(address, &value, sizeof(uint32_t));
}
...
{
//  return EEPROMClass::writeAll (address, value);
  return EEPROMClass::writeBytes(address, &value, sizeof(int64_t));
}

size_t EEPROMClass::writeULong64 (int address, uint64_t value)
{
//  return EEPROMClass::writeAll (address, value);
  return EEPROMClass::writeBytes(address, &value, sizeof(uint64_t));
}

size_t EEPROMClass::writeFloat (int address, float_t value)
{
//  return EEPROMClass::writeAll (address, value);
  return EEPROMClass::writeBytes(address, &value, sizeof(float_t));
}

size_t EEPROMClass::writeDouble (int address, double_t value)
{
//  return EEPROMClass::writeAll (address, value);
  return EEPROMClass::writeBytes(address, &value, sizeof(double_t));
}
...
//  return EEPROMClass::writeAll (address, Bool);
  return EEPROMClass::writeBytes(address, &Bool, sizeof(int8_t));
}
